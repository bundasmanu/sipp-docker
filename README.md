...
- [sipp-docker](#sipp-docker)
  ...
  - [UAC sends cancel](#uac-sends-cancel)
...
```sh
docker compose run sipp sipp -i 172.25.0.10 -p 5060 172.25.0.3:5060 -r 1 -m 1 -sf /opt/uas/uas_receives_cancel.xml -inf /opt/uas/uas.csv
